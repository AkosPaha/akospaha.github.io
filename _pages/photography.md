...
<div id="main" class="alt">
   ...
   <li>Android OS: Android 11 Fluid 1.0 R Official</li>
   <li>Camera app: Google Camera 7.6.008 V6 (Need Android 10 or newer)</li>
   <li>Edit app: Lightroom CC Mobile Premium 5.4.1</li>
<br><br>
<h2>Parrot Google Camera 7.6.008:(Newest)</h2>
	...
	<img
          width="100%"
          src="assets/images/gcam_parrot7.6.png"
          alt=""
          data-position="center center"
        />      
    <br><br>
    <h2>How to:</h2>
    <li>Download the Google Camera (Latest 7.6.008 V6 Stable <br> (Working on all device I guess)</li>
...
<li>When you use the front camera on Redmi 5 Plus (Vince) then default disabled Front Camera HDR+...<br>
I don't found gcam 7.6 which support it on Redmi 5 Plus (Vince) so its default disbale, on rear camera enabled and wroks fine.</li>
<li>Enjoy</li>
<li>Creating lots of good picture :)</li>
        ...
        <div class="6u$ 12u$(medium)">
            ...
            <h3>Downloads:</h3>
            <ul class="actions">
                <li><a target="_blank" href="https://drive.google.com/drive/folders/1943PHjcZKoPN7lk4kIZdGQAI8PrIWf7o?usp=sharing" class="button special">GCamera 7.6.008 V6 APK Download</a></li>
               <br><br>
...
<li>Creating lots of good picture :)</li>
        ...
        <div class="6u$ 12u$(medium)">
            ...
            <h3>Downloads:</h3>
            <ul class="actions">
                <li><a target="_blank" href="https://drive.google.com/drive/folders/12NNC3ybPyLBE75aE_U-LJsaaZu7Dexxg?usp=sharing" class="button special">GCamera 7.4.104 V5 APK Download</a></li>
               <br><br>
...
<li>Creating lots of good picture :)</li>
        ...
        <div class="6u$ 12u$(medium)">
            ...
            <h3>Downloads:</h3>
            <ul class="actions">
                <li><a target="_blank" href="https://drive.google.com/folderview?id=1-CPTnK7nDoIR5PZp8ThAXvHIc_lAwosR" class="button special">GCamera 7.3.020 V8 APK Download</a></li>
               <br><br>
