...
<li>Creating lots of good picture :)</li>
        ...
        <div class="6u$ 12u$(medium)">
            ...
            <h3>Downloads:</h3>
            <ul class="actions">
                <li><a class="fas fa-camera"></a><a target="_blank" href="https://drive.google.com/folderview?id=1-CPTnK7nDoIR5PZp8ThAXvHIc_lAwosR" class="button special">Google Camera 7.3.020 V8</a></li>
               <br><br>
